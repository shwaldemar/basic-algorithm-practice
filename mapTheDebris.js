...
//Hi, I agree that it would be better to give the formula in the challenge itself. //Formula is:

//T = 2 * pi * sqrt( r^3 / GM)
//where r = earthRadius+avgAlt, which is the distance from midpoint of the earth to the object, and T = Orbital Period.
